...
if True:
    for fil in dir_list:
        ...
        model = TransformerModel(ntoken=64, d_model=256, nhead=16, d_hid=256,
        ...
        loss_fn = nn.MSELoss()#nn.BCELoss()#NLLLoss() #nn.
